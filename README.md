...
# 🛠️ Technical Skills Across the Stack
### 💻 Languages

Python • JavaScript (ES6+) • C • HTML • CSS
...
- Secure environment setup (.env, process.env)

### 🗄️ Databases

- MongoDB + Mongoose
- Firestore (NoSQL document model)
- Schema design & data modeling
- Query optimization, indexes, validations
...
- Debugging with console, breakpoints, logs
...
- Full-stack ticket trading platform for UGA students
...
- Chat/messaging planned for v2
- Designed for conferences, meetups & student events

### 🧠 NeuroAid AI

- AI-powered dyslexia pre-screening tool for children
...
- Turn-based logic + legal move generator
- Custom evaluation function (in progress)

### 🚀 Career Goals

- Secure a Software Engineering internship (SWE)
...
🔗 LinkedIn: [https://www.linkedin.com/in/krisharathod05](https://www.linkedin.com/in/krisha-rathod05/)
